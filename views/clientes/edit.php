...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($cliente->nome)) {
        ...
        // Tenta atualizar
        if ($cliente->update()) {
            $_SESSION['success_message'] = "Cliente '{$cliente->nome}' atualizado com sucesso!";
            header("Location: index.php");
            exit;
        } else {
            $_SESSION['error_message'] = "Não foi possível atualizar o cliente.";
        }
    }
}
...
<div class="container mt-4">
    ...
    <div class="card card-primary">
        ...
        <form method="POST" action="edit.php?id=<?= $cliente_id ?>">
            <div class="card-body">
